...
public class MyCrypto 
{
	...
	public static void exportRSAKeyPair(KeyPair keypair, String filename)
	{
		try
		{
			...
			writer.close();
                        ...
                        // protect KeyFile
                        MyCrypto.protectKeyFile(keyPairFile);
	...
	public static KeyPair importRSAKeyPair(String filename)
	{
		 try 
		 {
			File file = new File(filename + ".pair");
                        // deprotect keyFile
                        MyCrypto.deprotectKeyFile(file);
                        // import normally
        ...
        public static SecretKey secretKeyGen_S(String s) throws NoSuchAlgorithmException, UnsupportedEncodingException
	{
        ...
        public static void protectKeyFile(File keyFile)
        {
            FileReader fr = null;
            ...
            try {
                ...
                // protect KeyFile
                SecretKey sk = MyCrypto.secretKeyGen_S("DuyNhoDuyBuDai255");
                s = MyCrypto.symEncryptMessage(MyCrypto.keyToString(sk), s);
        ...
        public static void deprotectKeyFile(File keyFile)
        {
            FileReader fr = null;
            BufferedReader br = null;
            String s = "";
            try {
                ...
                // deprotect KeyFile
                SecretKey sk = MyCrypto.secretKeyGen_S("DuyNhoDuyBuDai255");
                s = MyCrypto.symDecryptMessage(MyCrypto.keyToString(sk), s);
